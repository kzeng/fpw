...
//
// -----------------------------------------------------------------------------
unsigned short calcCrc16( unsigned char *data, unsigned short len, unsigned short crc )
{
    while (len>0)
    {
...
//
// -----------------------------------------------------------------------------
UINT_32 digital_update_crc32( UINT_32 crc, UINT_8 *data, UINT_16 len )
{
    while (len > 0)
    {
      crc = crc32table[*data ^ ((crc >> 24) & 0xff)] ^ (crc << 8);
...
//
// -----------------------------------------------------------------------------
UINT_32 digital_crc32( UINT_8 *buf, UINT_16 len)
{
